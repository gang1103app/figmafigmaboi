        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Empowering teens to save energy and protect our planet, one action at a time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#updates" className="text-gray-400 hover:text-primary transition-colors">
                  Updates
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#team" className="text-gray-400 hover:text-primary transition-colors">
                  Team
                </a>
              </li>
              <li>
                <a href="#careers" className="text-gray-400 hover:text-primary transition-colors">
                  Careers
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 sm:mb-0">
              © {new Date().getFullYear()} EcoTeen. All rights reserved.
            </div>
